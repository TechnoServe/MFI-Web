...
(function (global, factory) {
  ...
  const cssFormattedClasses = function (codePoints, options) {
    ...
    const _a = codePointsToCharacterClasses(codePoints, options.lineBreak); const indicies = _a[0]; let classTypes = _a[1]; const isLetterNumber = _a[2];
  ...
  const LineBreaker = function (str, options) {
    ...
    const _a = cssFormattedClasses(codePoints, options); const indicies = _a[0]; const classTypes = _a[1]; const forbiddenBreakpoints = _a[2];
    const length = codePoints.length;
    let lastEnd = 0;
    let nextIndex = 0;
    return {
  ...
  const Tokenizer = /** @class */ (function () {
    ...
    Tokenizer.prototype.consumeUnicodeRangeToken = function () {
      ...
      if (questionMarks) {
        const start_1 = parseInt(fromCodePoint.apply(void 0, digits.map(function (digit) {
    ...
    Tokenizer.prototype.consumeNumericToken = function () {
      const _a = this.consumeNumber(); const number = _a[0]; const flags = _a[1];
  ...
  const getAbsoluteValueForTuple = function (tuple, width, height) {
    const x = tuple[0]; const y = tuple[1];
  ...
  const rgb = function (args) {
    ...
    if (tokens.length === 3) {
      const _a = tokens.map(getTokenColorValue); var r = _a[0]; var g = _a[1]; var b = _a[2];
      return pack(r, g, b, 1);
    }
    if (tokens.length === 4) {
      const _b = tokens.map(getTokenColorValue); var r = _b[0]; var g = _b[1]; var b = _b[2]; const a = _b[3];
      return pack(r, g, b, a);
    }
    return 0;
  };
  ...
  const hsl = function (args) {
    const tokens = args.filter(nonFunctionArgSeparator);
    const hue = tokens[0]; const saturation = tokens[1]; const lightness = tokens[2]; const alpha = tokens[3];
  ...
  const findCorner = function (width, height, x, y, closest) {
    ...
    return corners.reduce(function (stat, corner) {
      const cx = corner[0]; const cy = corner[1];
    ...
    switch (gradient.size) {
      ...
      case CSSRadialExtent.CLOSEST_CORNER:
        ...
        if (gradient.shape === CSSRadialShape.CIRCLE) {
          ...
          const _a = findCorner(width, height, x, y, true); var cx = _a[0]; var cy = _a[1];
      ...
      case CSSRadialExtent.FARTHEST_CORNER:
        ...
        if (gradient.shape === CSSRadialShape.CIRCLE) {
          ...
          const _b = findCorner(width, height, x, y, false); var cx = _b[0]; var cy = _b[1];
          rx = distance(cx - x, (cy - y) / c);
          ry = c * rx;
        }
        break;
  ...
  const Logger = /** @class */ (function () {
    function Logger(_a) {
      const id = _a.id; const enabled = _a.enabled;
      this.id = id;
  ...
  var Cache = /** @class */ (function () {
    ...
    Cache.prototype.loadImage = function (key) {
      return __awaiter(this, void 0, void 0, function () {
        let isSameOrigin; let useCORS; let useProxy; let src;
        const _this = this;
  ...
  const matrix3d = function (args) {
    ...
    const a1 = values[0]; const b1 = values[1]; const _a = values[2]; const _b = values[3]; const a2 = values[4]; const b2 = values[5]; const _c = values[6]; const _d = values[7]; const _e = values[8]; const _f = values[9]; const _g = values[10]; const _h = values[11]; const a4 = values[12]; const b4 = values[13]; const _j = values[14]; const _k = values[15];
      ...
      declaration.content.forEach(function (token) {
        if (token.type === TokenType.STRING_TOKEN) {
          ...
          if (token.name === 'attr') {
            ...
            const _a = token.values.filter(nonFunctionArgSeparator); var counter = _a[0]; var counterStyle = _a[1];
            ...
            const _b = token.values.filter(nonFunctionArgSeparator); var counter = _b[0]; const delim = _b[1]; var counterStyle = _b[2];
            if (counter && isIdentToken(counter)) {
  ...
  var restoreNodeScroll = function (_a) {
    const element = _a[0]; const x = _a[1]; const y = _a[2];
  ...
  const BoundCurves = /** @class */ (function () {
    function BoundCurves(element) {
      ...
      const _a = getAbsoluteValueForTuple(styles.borderTopLeftRadius, bounds.width, bounds.height); let tlh = _a[0]; let tlv = _a[1];
      const _b = getAbsoluteValueForTuple(styles.borderTopRightRadius, bounds.width, bounds.height); let trh = _b[0]; let trv = _b[1];
      const _c = getAbsoluteValueForTuple(styles.borderBottomRightRadius, bounds.width, bounds.height); let brh = _c[0]; let brv = _c[1];
      const _d = getAbsoluteValueForTuple(styles.borderBottomLeftRadius, bounds.width, bounds.height); let blh = _d[0]; let blv = _d[1];
      const factors = [];
  ...
  const TransformEffect = /** @class */ (function () {
    function TransformEffect(offsetX, offsetY, matrix) {
      ...
      this.matrix = matrix;
      this.target = 2 /* BACKGROUND_BORDERS */ | 4;
    }
  ...
  const calculateBackgroundRendering = function (container, index, intrinsicSize) {
    ...
    const sizeWidth = backgroundImageSize[0]; const sizeHeight = backgroundImageSize[1];
  ...
  var calculateBackgroundSize = function (size, _a, bounds) {
    const intrinsicWidth = _a[0]; const intrinsicHeight = _a[1]; const intrinsicProportion = _a[2];
    const first = size[0]; const second = size[1];
  ...
  var calculateBackgroundRepeatPath = function (repeat, _a, _b, backgroundPositioningArea, backgroundPaintingArea) {
    const x = _a[0]; const y = _a[1];
    const width = _b[0]; const height = _b[1];
    switch (repeat) {
  ...
  const CanvasRenderer = /** @class */ (function () {
    ...
    CanvasRenderer.prototype.renderTextWithLetterSpacing = function (text, letterSpacing) {
      ...
      if (letterSpacing === 0) {
        ...
        const letters = toCodePoints(text.text).map(function (i) {
          return fromCodePoint(i);
        });
    ...
    CanvasRenderer.prototype.renderTextNode = function (text, styles) {
      return __awaiter(this, void 0, void 0, function () {
        let _a; let font; let fontFamily; let fontSize;
        const _this = this;
    ...
    CanvasRenderer.prototype.renderNodeContent = function (paint) {
      return __awaiter(this, void 0, void 0, function () {
        let container; let curves; let styles; let _i; let _a; let child; var image; let e_1; var image; let e_2; let iframeRenderer; let canvas; let size; var bounds; let x; let textBounds; let img; var image; let url; let e_3; var bounds;
        return __generator(this, function (_b) {
          switch (_b.label) {
            case 0:
    ...
    CanvasRenderer.prototype.renderStackContent = function (stack) {
      return __awaiter(this, void 0, void 0, function () {
        let _i; let _a; var child; let _b; let _c; var child; let _d; let _e; var child; let _f; let _g; var child; let _h; let _j; var child; let _k; let _l; var child; let _m; let _o; var child;
    ...
    CanvasRenderer.prototype.renderBackgroundImage = function (container) {
      return __awaiter(this, void 0, void 0, function () {
        let index; let _loop_1; let this_1; let _i; let _a; let backgroundImage;
        return __generator(this, function (_b) {
          switch (_b.label) {
            case 0:
              index = container.styles.backgroundImage.length - 1;
              _loop_1 = function (backgroundImage) {
                let image; let url; let e_4; let _a; var path; var x; var y; var width; var height; var pattern; let _b; var path; var x; var y; var width; var height; let _c; let lineLength; let x0; let x1; let y0; let y1; let canvas; let ctx; let gradient_1; var pattern; let _d; var path; let left; let top_1; var width; var height; let position; var x; var y; let _e; let rx; let ry; let radialGradient_1; let midX; let midY; let f; let invF;
    ...
    CanvasRenderer.prototype.renderNodeBackgroundAndBorders = function (paint) {
      return __awaiter(this, void 0, void 0, function () {
        let styles; let hasBackground; let borders; let backgroundPaintingArea; let side; let _i; let borders_1; let border;
        const _this = this;
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
  ...
  const parseColor$1 = function (value) {
    return color.parse(Parser.create(value).parseComponentValue());
  };
  ...
  var renderElement = function (element, opts) {
    return __awaiter(_this, void 0, void 0, function () {
      let ownerDocument; let defaultView; let instanceName; let _a; let width; let height; let left; let top; let defaultResourceOptions; let resourceOptions; let defaultOptions; let options; let windowBounds; let documentCloner; let clonedElement; let container; let documentBackgroundColor; let bodyBackgroundColor; let bgColor; let defaultBackgroundColor; let backgroundColor; let renderOptions; let canvas; var renderer; let root; var renderer;
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:

...
import flourMills from 'assets/company_images/fmn-logo-black.png';
...
const LandingHero = () => {
  ...
  document.addEventListener('DOMContentLoaded', () => {
    ...
    const twoDaysFromNow = Math.floor(new Date('March 26, 2024 11:00:00').getTime() / 1000);// (new Date().getTime() / 1000) + (86400 * 21) + 1;

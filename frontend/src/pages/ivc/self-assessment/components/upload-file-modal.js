...
/**
 * UploadFileModal renders a modal that allows users to view recent uploads
 * and select a source (System, Dropbox, or Google Drive) to upload a new file.
 *
 * @component
 * @returns {JSX.Element} The modal UI for file uploads
 */
const UploadFileModal = () => {
  // Fullscreen overlay with a dark background and centered modal layout
  return (
    <div
    ...
    >
      {/* Main modal container with white background, rounded corners, and padding */}
      <div className="background-color-white border-1px padding-10 box-shadow-large rounded-large width-192">
        {/* Header section showing "Recent uploads" label and "See all" link */}
        ...
        {/* Grid layout displaying five different types of recently uploaded files */}
        ...
        {/* Header section for file upload sources */}
        ...
        {/* Upload source buttons for System, Dropbox, and Google Drive */}
      ...
      {/* Floating close button positioned outside the modal */}
